  ...
  return (
    <section id="contact" className="bg-purpleTheme text-white py-16">
      <div className="max-w-5xl mx-auto px-4 text-center">
        ...
        <a href="mailto:seuemail@exemplo.com" className="bg-purpleTheme-light text-purpleTheme-dark px-6 py-3 rounded-md hover:bg-purpleTheme-dark hover:text-white">
          Enviar Email
        </a>
      </div>
    </section>
