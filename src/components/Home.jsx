...
const Home = () => {
  return (
    <section className="bg-purple-700 text-white h-screen flex flex-col md:flex-row justify-between items-center p-8 md:p-16">
      ...
      <div className="md:w-1/2 flex justify-center">
        <img src="/img/matheus.jpg" alt="matheus" className="rounded-full w-48 h-48 md:w-60 md:h-60 border-4 border-purple-500 shadow-lg"/>
      </div>
    </section>
  );
};
